<template>
  <div class="Timeline">
    <div class="row">
      <div class="col-sm-12 mb-4" id="Timeline">
            ...
            <div class="row">
              <div class="col table-responsive">
                <table class="table">
                  <thead>
                    <tr>
                      <th scope="col-sm-12">Year</th>
                      <th scope="col-sm-12">Where</th>
                      <th scope="col-sm-12">Title - Description</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td>Summer 2020 - Current</td>
                      <td><span style="color:#006699">IBM</span></td>
                    ...
                    <tr>
                      ...
                      <td><i>President</i> - <br> Marist College Computer Society</td>
                    </tr>
                    <tr>
                      <td>Spring 2020</td>
                      <td><span style="color:#C8102E">Marist College</span></td>
                      <td><i>Computer Science Lab Tutor</i> - <br> A fun group of lads</td>
                    </tr>
                    <tr>
                      <td>Summer 2019 - Spring 2020</td>
                      <td><span style="color:#006699">IBM</span></td>
                      <td><i>Co-Op Software Developer</i> - <br> Z Spark Open Data Analytics</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>Spring 2019</td>
                      <td><span style="color:#C8102E">Marist College</span></td>
                      <td><i>Advisory Board Member</i> - <br> Marist College Multicultural Community</td>
                    </tr>
                    <tr>
                      <td>Fall 2019</td>
                      <td><span style="color:#C8102E">Marist College</span></td>
                      <td><i>Vice President</i> - <br> Marist College Computer Society</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><span style="color:#C8102E">Marist College</span></td>
                      <td><i>Desktop Technician</i> - <br> Residential Networking</td>
                    </tr>
                    <tr>
                      <td>Fall 2017 - Spring 2021</td>
                      <td><span style="color:#C8102E">Marist College</span></td>
                      <td><i>Major/Minors</i> - <br> Computer Science/Math, Philosophy, IT, and IS</td>
                    </tr>
                  </tbody>
                </table>
              </div>
